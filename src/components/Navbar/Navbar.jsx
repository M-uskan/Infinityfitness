      ...
      <div className="container">
        <div className="flex justify-between items-center">
          <div className="sm:flex items-center gap-3 hidden font-semibold text-gray-500 dark:text-gray-400 group">
            <BiPhoneCall className="text-primary text-2xl animate-pulse group-hover:scale-200 duration-200" />{" "}
            +91 9416698401
          </div>
          <div>
            <img
              src={Logo2}
              alt=""
              className="w-16 sm:w-24 absolute top-3 left-0 sm:left-1/2 sm:-translate-x-1/2 m-2 sm:m-0 "
            />
          </div>
